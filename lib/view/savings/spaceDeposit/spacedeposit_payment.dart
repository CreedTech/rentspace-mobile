...
class SpaceDepositPayment extends StatefulWidget {
  double amount;
  String refId;
  SpaceDepositPayment({Key? key, required this.amount, required this.refId})
      : super(key: key);

  @override
  _SpaceDepositPaymentState createState() => _SpaceDepositPaymentState();
}
...
class _SpaceDepositPaymentState extends State<SpaceDepositPayment> {
  ...
  createPayment() async {
    ...
    final response = await http.post(
      ...
      body: jsonEncode(<String, String>{
        ...
        "transaction_ref": "DEP${widget.refId}",
