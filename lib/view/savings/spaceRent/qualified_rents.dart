...
import 'spacerent_creation.dart';
import 'spacerent_page.dart';

class QualifiedRents extends StatefulWidget {
  const QualifiedRents({super.key});

  @override
  State<QualifiedRents> createState() => _QualifiedRentsState();
}
...
class _QualifiedRentsState extends State<QualifiedRents> {
  ...
  bool _hasQualifiedRents() {
    return rentController.rentModel!.rents!
        .any((rent) => rent.paidAmount >= 70);
  }
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      'Space Rents Eligible for Loan Request:',
